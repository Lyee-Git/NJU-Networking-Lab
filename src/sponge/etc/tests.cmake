...
add_custom_target (check_lab2_1 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_webget|t_byte_stream|_dt'
                              COMMENT "Testing Lab 2-part 1...")     
add_custom_target (check_lab2_2 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_strm_reassem_|t_byte_stream|_dt'
                              COMMENT "Testing Lab 2-part 2: the stream reassembler...")                              
add_custom_target (check_lab3 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_recv_|t_wrapping_|t_strm_reassem_|t_byte_stream|_dt'
                              COMMENT "Testing the TCP receiver...")
add_custom_target (check_lab4 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_send_|t_recv_|t_wrapping_|t_strm_reassem_|t_byte_stream|_dt'
                              COMMENT "Testing the TCP sender...")
add_custom_target (check_lab5 COMMAND "${PROJECT_SOURCE_DIR}/tun.sh" check 144 145
                              COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R "^t_"
                              COMMENT "Testing the TCP connection...")
add_custom_target (check_lab6 COMMAND "${PROJECT_SOURCE_DIR}/tap.sh" check 10
                              COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R '^t_webget|^arp_'
                              COMMENT "Testing Lab 6...")
add_custom_target (check_lab7 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R '^arp_|^router_'
                              COMMENT "Testing Lab 7...")
