...
class RouteEntry {
  ...
  RouteEntry(uint32_t route_prefix, uint8_t prefix_length, std::optional<Address> next_hop, size_t interface_num):_route_prefix(route_prefix), _prefix_length(prefix_length), _next_hop(next_hop), _interface_num(interface_num){}
};
